    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['17.11.12', '17.02.13', '18.05.13', '18.08.13', '16.11.13', '16.02.14',
                '17.05.14', '17.08.14', '15.11.14', '15.02.15', '16.05.15', '16.08.15','21.11.2015','21.02.2016','21.05.2016','27.08.2016','20.05.2017']
        },
        yAxis: {
            title: {
        ...
        series: [{
            name: 'Н.Новгород',
            data: [4, 12, 15, 28, 23, 30, 43, 45, 37, 54, 82, 70,73,54,84,59,71]
        }]
    });
});
