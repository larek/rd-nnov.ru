...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/admin-template/plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="/admin-template/plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="/admin-template/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="/admin-template/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="/admin-template/plugins/daterangepicker/daterangepicker-bs3.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="/admin-template/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
    ...
    <script src="/admin-template/plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
    ...
    <!-- jQuery Knob Chart -->
    <script src="/admin-template/plugins/knob/jquery.knob.js"></script>
    <!-- daterangepicker -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
    <script src="/admin-template/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- datepicker -->
    <script src="/admin-template/plugins/datepicker/bootstrap-datepicker.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
    ...
    <!-- FastClick -->
    <script src="/admin-template/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
