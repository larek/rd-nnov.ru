...
<body>
    ...
    <div class="wrap">
        ...
        <?php Yii::$app->request->pathInfo == "" ? $class = 'container1' : $class = 'container'; ?>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/33392643" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
